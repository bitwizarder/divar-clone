...
export const metadata = {
  title: "پنل مدیریت | منو‌ها",
  description: "لیست منو‌ها در پنل مدیریت",
};
      ...
      <div className="flex flex-col gap-4 rounded-2xl border border-color bg-surface p-5 shadow-sm sm:flex-row sm:items-center sm:justify-between sm:p-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted flex items-center flex-wrap gap-2">
                <span>مدیریت منوهای آگهی‌ها</span>
                {menus.menu_count && (
                  <span className="bg-hover px-3 py-1 text-gray rounded-full">
                    تعداد رکورد ها ({menus.menu_count})
                  </span>
                )}
              </p>
            </div>
        ...
        <div className="flex gap-2">
          ...
          >
            ...
            <span className="text-nowrap">ایجاد منو جدید</span>
          </Link>
        </div>
      </div>
      ...
      <Suspense fallback={null}>
        <SuccessMessage
          messages={{
            ...
            deletesSuccess: "منو های انتخاب شده با موفقیت حذف شدند.",
          }}
        />
      </Suspense>
